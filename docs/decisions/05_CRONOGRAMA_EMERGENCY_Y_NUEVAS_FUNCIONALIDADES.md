...
| 4 — Simulación del corredor | Vehículos virtuales (ambulancia/carro/moto), reproducción determinística, los 12 escenarios mínimos del roadmap. ✅ Escenario 1 (10 vehículos, ADR-0022 — encontró y corrigió un bug real de muestreo en `sampleAhead`), ✅ Escenario 2 (100 vehículos — valida escala real de `findNearby`/GEOSEARCH, latencia 3.22ms→8.73ms al 10x vehículos) y ✅ Escenario 3 (tres ambulancias simultáneas, 2026-09-01 — valida aislamiento real entre corredores concurrentes, `SimulationEngineService.runConcurrent`, 10/10 casos reales). Pendiente: escenarios 4–12 (vehículo fuera de ruta, GPS con ruido/atraso, desconexión, reconexión, corredores que sí se cruzan), métricas de falsos positivos/conflictos perdidos | Fase 3 | — | 1–2 semanas — en curso (3/12) |
