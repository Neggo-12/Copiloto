...
| 4 — Simulación del corredor | Vehículos virtuales (ambulancia/carro/moto), reproducción determinística, los 12 escenarios mínimos del roadmap. ✅ Escenario 1 (1 ambulancia/10 vehículos, ADR-0022 — encontró y corrigió un bug real de muestreo en `sampleAhead`) y ✅ Escenario 2 (1 ambulancia/100 vehículos, 2026-09-01 — valida escala real de `findNearby`/GEOSEARCH, latencia 3.22ms→8.73ms al 10x vehículos, 8/8 casos reales). Pendiente: escenarios 3–12 (varias ambulancias simultáneas, GPS con ruido/atraso, desconexión, reconexión, corredores cruzados), métricas de falsos positivos/conflictos perdidos | Fase 3 | — | 1–2 semanas — en curso (2/12) |
